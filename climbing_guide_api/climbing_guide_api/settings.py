"""
Django settings for climbing_guide_api project.
...
SECRET_KEY = 'rnd%wsoh=9mnq65zx#%v$^-iq9srv5p)85l(o*s1o+pnb8rfu!'
...
ROOT_URLCONF = 'climbing_guide_api.urls'
...
WSGI_APPLICATION = 'climbing_guide_api.wsgi.application'
